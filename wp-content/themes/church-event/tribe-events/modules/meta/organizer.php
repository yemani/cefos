...
<div class="tribe-events-meta-group tribe-events-meta-group-organizer">
	<dl>
		...
		<dt> <?php _e('Organizer:', 'church-event' ) ?> </dt>
		<dd class="fn org"> <?php echo tribe_get_organizer() ?> </dd>

		<?php if ( ! empty( $phone ) ): ?>
			<dt> <?php _e( 'Phone:', 'the-events-calendar' ) ?> </dt>
			<dd class="tel"> <?php echo tribe_get_organizer_phone() ?> </dd>
		<?php endif ?>

		<?php if ( ! empty( $email ) ): ?>
			<dt> <?php _e( 'Email:', 'the-events-calendar' ) ?> </dt>
			<dd class="email"> <?php echo tribe_get_organizer_email() ?> </dd>
		<?php endif ?>

		<?php if ( ! empty( $website ) ): ?>
			<dt> <?php _e( 'Organizer Website:', 'church-event' ) ?> </dt>
