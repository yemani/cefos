...
function wpv_importer_init() {
	if ( defined( 'WPV_SAMPLES_DIR' ) ) {
		$GLOBALS['wpv_import'] = new WPV_Import();
		register_importer( 'wpv', 'Vamtam Demo Content', sprintf( esc_html__( 'Import posts, pages, comments, custom fields, categories, tags and sidebars from a %s dummy content file.', 'wordpress-importer' ), THEME_NAME ), array( $GLOBALS['wpv_import'], 'dispatch' ) );
	}
}
