<ul class="clearfix">
	<li class="post-format-pad"><a title="<?php esc_attr_e('Standard', 'church-event')?>" href="<?php echo esc_attr( add_query_arg( 'format_filter','standard',home_url()) ) ?>" class="standard"><?php echo do_shortcode('[icon name="'.WpvPostFormats::get_post_format_icon('standard').'"]')?></a></li>
	<?php
