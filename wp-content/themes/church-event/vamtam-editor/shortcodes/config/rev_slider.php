<?php
return array(
	'name' => __('Revolution Slider', 'church-event') ,
	...
	If you need to activate the slider in the Header, then you will need the option - "Page Slider" found below the editor. ' , 'church-event'),
	'icon' => array(
